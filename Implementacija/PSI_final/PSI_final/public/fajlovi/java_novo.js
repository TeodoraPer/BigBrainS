...
var selectedValue1;
  ...
  {     alert("Žao nam je, dodali ste sve usluge koje su na raspolaganju!")
        return; }
...
{   var e = document.getElementById("izborUsluga"+(pozicijaCitanja).toString());
  ...
  { 
    document.getElementById("porukaUslugeGreska").innerHTML="<div class='alert'>Da biste dodali novu uslugu, morate popuniti sva polja cena prethodne usluge!</div>";
    return;}
   if(selectedValue=="Izaberite uslugu")  { 
      document.getElementById("porukaUslugeGreska").innerHTML="<div class='alert'>Da biste dodali novu uslugu, morate izabrati prethodnu!</div>";
      return;}
 ...
 function sakrijRed(){ 
   if(pozicijaCitanja==0) { 
    document.getElementById("porukaUslugeGreska").innerHTML="<div class='alert'>Žao nam je, morate imati bar jednu uslugu!</div>"; return}
    pozicijaCitanja--;
