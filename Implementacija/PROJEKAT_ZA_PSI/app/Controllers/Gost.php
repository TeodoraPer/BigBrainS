<?php
/**
 * Peric Teodora 0283/18 funkcionalnost Registracija
...
class Gost extends BaseController { 
   ...
   */
  function prikaz($page,$data,$isRegistration=null){ 
   ...
   */
      ...
      */
        ...
        $file = $_FILES['img'];
         ...
         if(!$this->validate(['nazivSalon'=>'required|min_length[1]|max_length[45]',
           ...
           'ponPetakDo'=>'required',
          // 'img'=>'required'
           ])||($file == null)||!in_array( $fileActualExtension,$allowed)||!($fileError===0)){ 
           $nizGresaka=$this->validator->getErrors();
                  ...
                  if(isset($_POST['daLiJeSveIspravnoKodUsluga'])&&$_POST['daLiJeSveIspravnoKodUsluga']=='N')  
                   $nizGresaka['usluga0']="Morate popuniti informacije o uslugama ispravno!";
            //       if(isset($nizGresaka['img'])) $nizGresaka['img']='Izaberite sliku!';
                   if(($file == null)) {
                 ...
                 if($_POST['nedeljaOd']!=null&&$_POST['nedeljaDo']!=null){ 
                  ...
                  if($_POST['ponPetakOd']!=null&&$_POST['ponPetakDo']!=null){ 
                     ...
                     {   $nizGresaka['ponPetakOd']="Morate postaviti radno vreme ponedeljak-petak ispravno!";   
                     }} 
                  } 
       ...
       if($korisnik!=null){ 
         //  $nizGresaka['usluga0']="Morate ponovo popuniti informacije o uslugama!";
           ...
           return $this->prikaz('registracija',['poruka'=>$poruka, 'resetuj'=>$resetuj],"registracija");
       }
     ...
     * Funkcionalnost Registracija, provera ispravnosti vremenskih polja
     * @param type $prvi
     * @param type $drugi
     * @return boolean
     */ 
    ...
    *
    */
  public function poslatZahtevZaRegistraciju(){
    ...
    public function loginObrada() {
        ...
        if ($korisnik->lozinka != $lozinka) {
            return $this->prikaz('login', ['errors' => ['greska' => 'Pogrešna lozinka!']]);
        }
 ...
 */
  ...
  function saznajViseOSalonu($idSalon,$offset=0){ 
     //   $regKorisnik=new RegKorisnikModel();
        ...
        $salonModel=Factories::models('App\Models\SalonModel');
