            ...
            <div class="login"> <br>
                <form name="login_forma" method="post" action="<?= site_url("$controller/loginObrada") ?>">
                    <table cellpadding="10px">
                        ...
                        <tr>
                            <td>   <input class="inpt" type="text" name="korime" id="korime" required 
                                          oninvalid="this.setCustomValidity('Morate uneti korisnicko ime!')" oninput="setCustomValidity('')" 
                                          value="<?php  if(isset($poruka)||(!empty($errors['greska'])&&$errors['greska']=="Korisnik ne postoji!")) echo ""; else echo set_value('korime') ?>"
                                          placeholder="Korisničko ime"/></td>
                        </tr>
                        <tr>
                            <td class="porukica1 error" >
                                &nbsp;
                    ...
                    <div class="Login_dugme">
                        <button type="submit" class="button2" name='loginDugme'>LOGIN</button><br>
