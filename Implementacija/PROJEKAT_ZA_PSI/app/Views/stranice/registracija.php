...
?>
   <div class="row divCentar">
         ...
         <?php if(isset($poruka)) echo "<p class='alert alert-danger  ' style='margin-left:300px; margin-right:300px' role='alert'>$poruka</p>"; ?>
                     ...
                     <form  name="korisnikovaForma" enctype= "multipart/form-data" action="<?= site_url("Gost/registracijaSubmitKorisnik") ?>" method="post" >
                        <table class="text-center tabela" style="margin-top:30px;" cellpadding="5px">
                            ...
                            <tr >
                                ...
                                <td> <input class="inpt3 " type="text"  maxlength="45"  
                                            name="imeKorisnik"  
                                            required 
                                          oninvalid="this.setCustomValidity('Morate uneti ime!')" oninput="setCustomValidity('')" 
                                            value="<?php if(isset($resetujSve)||!empty($errors['imeKorisnik'])) echo "" ;else echo set_value("imeKorisnik") ?>"
                                           placeholder="Ime" ></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>   <input class="inpt3 " type="text"  maxlength="45"  
                                              required 
                                          oninvalid="this.setCustomValidity('Morate uneti prezime!')" oninput="setCustomValidity('')"  placeholder="Prezime" name="prezimeKorisnik"  value="<?php if(isset($resetujSve)||!empty($errors['prezimeKorisnik'])) echo ""; else echo set_value('prezimeKorisnik') ?>"
                                          ></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>       <input class="inpt3 " maxlength="45"  
                                                  required 
                                          oninvalid="this.setCustomValidity('Morate uneti korisničko ime!')" oninput="setCustomValidity('')" 
                                                  
                                                  type="text"  placeholder="Korisničko ime" name="korisnickoImeKorisnik"  
                            ...
                            <tr>
                                ...
                                <td>   <input class="inpt3 " maxlength="45"  
                                              required 
                                          oninvalid="this.setCustomValidity('Morate uneti email!')" oninput="setCustomValidity('')" 
                                              type="text" placeholder="email@gmail.com" name="emailKorisnik"  value="<?php if((isset($resetuj)&& str_contains($resetuj,'emailKorisnik')) ||isset($resetujSve)
                            ...
                            <tr > 
                             ...
                             <td class="desno"> Broj telefona:</td>
                               <td>   <input class="inpt3 " 
                                             required 
                                          oninvalid="this.setCustomValidity('Morate uneti broj telefona!')" oninput="setCustomValidity('')" 
                                             type="text" placeholder="+381" name="brojTelefonaKorisnik"  value="<?php if((isset($resetuj)&& str_contains($resetuj,'brojTelefonaKorisnik')) ||isset($resetujSve)||(!empty($errors['brojTelefonaKorisnik'])))
                              ...
                              <tr>
                               ...
                               <td>   <input class="inpt3 " type="text" maxlength="45"  
                                             required 
                                          oninvalid="this.setCustomValidity('Morate uneti adresu!')" oninput="setCustomValidity('')" 
                                             placeholder="Adresa" name="adresaKorisnik"  value="<?php if(isset($resetujSve)||!empty($errors['adresaKorisnik'])) echo ""; else echo set_value('adresaKorisnik') ?>"
                                            ></td>
                              </tr>
                        ...
                        <tr > 
                          ...
                          <?php if(!empty($errors['lozinkaKorisnik'])) 
                           ...
                           <tr>
                             ...
                             <td>   <input class="inpt3 " maxlength="45"  
                                           required 
                                          oninvalid="this.setCustomValidity('Morate uneti lozinku!')" oninput="setCustomValidity('')" 
                                           type="password" placeholder="Lozinka"  name="lozinkaKorisnik"  value="<?php if(isset($resetujSve)||!empty($errors['lozinkaKorisnik'])) echo set_value("");?>"
                                         ></td>
                           </tr>
                            ...
                            <tr > 
                             ...
                             <td>   <input class="inpt3 " maxlength="45"  
                                           required 
                                          oninvalid="this.setCustomValidity('Morate uneti potvrdu lozinke!')" oninput="setCustomValidity('')" 
                                           type="password" placeholder="Potvrda lozinke" name="potvrdaLozinkeKorisnik"  value="<?php if(isset($resetujSve)||!empty($errors['potvrdaLozinkeKorisnik']))echo set_value("");?>"
                                            ></td>
                              </tr>
                        ...
                        <table class="text-center tabela" style="margin-top:30px;" cellpadding="5px">
                            ...
                            <tr >
                                ...
                                <td> <input class="inpt3 " maxlength="45"  
                                            required 
                                          oninvalid="this.setCustomValidity('Morate uneti ime!')" oninput="setCustomValidity('')" 
                                            type="text"   name="imeMenadzer"  value="<?php if(isset($resetujSveM)||!empty($errorsMenadzer['imeMenadzer'])) echo "" ;else echo set_value("imeMenadzer") ?>"
                                           placeholder="Ime" ></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>   <input class="inpt3 "  maxlength="45"  
                                              required 
                                          oninvalid="this.setCustomValidity('Morate uneti prezime!')" oninput="setCustomValidity('')" 
                                              type="text" placeholder="Prezime" name="prezimeMenadzer"  value="<?php if(isset($resetujSveM)||!empty($errorsMenadzer['prezimeMenadzer'])) echo ""; else echo set_value('prezimeMenadzer') ?>"
                                          ></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>       <input class="inpt3 " type="text" maxlength="45"  
                                                  required 
                                          oninvalid="this.setCustomValidity('Morate uneti korisničko ime!')" oninput="setCustomValidity('')" 
                                                  placeholder="Korisničko ime" name="korisnickoImeMenadzer"  
                            ...
                            <tr>
                                <td class="desno"> Email:</td>
                                <td>   <input class="inpt3 " maxlength="45"   required  
                                          oninvalid="this.setCustomValidity('Morate uneti email!')" oninput="setCustomValidity('')"  type="text" placeholder="email@gmail.com" name="emailMenadzer"  value="<?php if((isset($resetuj)&& str_contains($resetuj,'emailMenadzer')) ||isset($resetujSveM)
                            ...
                            <tr > 
                             ...
                             <td class="desno"> Broj telefona:</td>
                               <td>   <input class="inpt3 "
                                             required 
                                          oninvalid="this.setCustomValidity('Morate uneti broj telefona!')" oninput="setCustomValidity('')" 
                                             type="text" placeholder="+381" name="brojTelefonaMenadzer"  value="<?php if((isset($resetuj)&& str_contains($resetuj,'brojTelefonaMenadzer')) ||isset($resetujSveM)||(!empty($errorsMenadzer['brojTelefonaMenadzer'])))
                              ...
                              <tr>
                               ...
                               <td>   <input class="inpt3 "  maxlength="45"  
                                             required 
                                          oninvalid="this.setCustomValidity('Morate uneti adresu!')" oninput="setCustomValidity('')" 
                                             type="text" placeholder="Adresa" name="adresaMenadzer" 
                          ...
                          <?php if(!empty($errorsMenadzer['lozinkaMenadzer'])) 
                           ...
                           <tr>
                             ...
                             <td>   <input class="inpt3 " maxlength="45"  
                                           required 
                                          oninvalid="this.setCustomValidity('Morate uneti lozinku!')" oninput="setCustomValidity('')" 
                                           type="password" placeholder="Lozinka"  name="lozinkaMenadzer"  value="<?php if(isset($resetujSveM)||!empty($errorsMenadzer['lozinkaMenadzer'])) echo set_value("");?>"
                                         ></td>
                           </tr>
                            ...
                            <tr > 
                             ...
                             <td>   <input class="inpt3 " maxlength="45"  
                                           required 
                                          oninvalid="this.setCustomValidity('Morate uneti potvrdu lozinke!')" oninput="setCustomValidity('')" 
                                           type="password" placeholder="Potvrda lozinke" name="potvrdaLozinkeMenadzer"  value="<?php if(isset($resetujSveM)||!empty($errorsMenadzer['potvrdaLozinkeMenadzer'])) echo set_value("");?>"
                                            ></td>
                              </tr>
                        ...
                        <form name="salonovaForma" enctype= "multipart/form-data" action="<?= site_url("Gost/registracijaSubmitSalon") ?>" method="post">
                            ...
                            <table class="text-center tabela" style="margin-top:30px; margin-left: 15px; text-align: left;"  cellpadding="5px">
                                ...
                                <tr >
                                    ...
                                    <td> <input class="inpt3 " maxlength="45"  
                                                required 
                                          oninvalid="this.setCustomValidity('Morate uneti naziv!')" oninput="setCustomValidity('')" 
                                                type="text" placeholder="Naziv" name="nazivSalon" 
                                ...
                                <tr>
                                    ...
                                    <td>   <input class="inpt3 "  maxlength="45"  
                                                  required 
                                          oninvalid="this.setCustomValidity('Morate uneti email!')" oninput="setCustomValidity('')" 
                                                  type="text" placeholder="email@gmail.com" name="emailSalon"
                                 ...
                                 <td class="desno"> Broj telefona:</td>
                                  ...
                                  <tr>
                                     ...
                                     <td>   <input class="inpt3" maxlength="45"  
                                                   required 
                                          oninvalid="this.setCustomValidity('Morate uneti adresu!')" oninput="setCustomValidity('')" 
                                                   type="text" placeholder="Adresa" name="adresaSalon" 
                            ...
                            <tr > 
                              <td colspan="2" class="porukica2 error"> <?php if(!empty($errorsSalon['lozinkaSalon'])) 
                               ...
                               <tr>
                                  <td class="desno"> Lozinka:</td>
                                 <td>   <input class="inpt3 " type="password"  maxlength="45"  
                                               required 
                                          oninvalid="this.setCustomValidity('Morate uneti lozinku!')" oninput="setCustomValidity('')" 
                                               placeholder="Lozinka" name="lozinkaSalon" value="<?php if(isset($resetujSveS)||!empty($errorsSalon['lozinkaSalon'])) echo set_value("");?>"></td>
                               </tr>
                                ...
                                <tr > 
                                 ...
                                 <td>   <input class="inpt3 "  maxlength="45"  
                                          ...
                                          oninvalid="this.setCustomValidity('Morate uneti potvrdu lozinke!')" oninput="setCustomValidity('')" 
                                               ...
                                               type="password" placeholder="Potvrda lozinke" name="potvrdaLozinkeSalon"value="<?php if(isset($resetujSveS)||!empty($errorsSalon['potvrdaLozinkeSalon'])) echo set_value("");?>"></td>
                                  </tr>
                              </table>
                                         ...
                                         <div class="dodajSliku" style="margin-right:200px ;">
                                                <label id="idlabel" for="inputTag" >
                                                  ...
                                                  <input id="inputTag" 
                                                         ...
                                                         type="file" name="img" style="height: 300px" 
                            ...
                            <div class="registracijaSalon3" style="margin-left:  540px; margin-top: -610px" id="salon2">
                                ...
                                <table class="text-center tabela" style="margin-top:-15px; margin-left: 15px;" cellpadding="5px">
                                    ...
                                    <tr>
                                        <td colspan="2"  style="text-align:left;">Ponedeljak-Petak <input class="inpt2 "type="time"  id="od" placeholder="OD" required 
                                          oninvalid="this.setCustomValidity('Morate uneti vreme!')" oninput="setCustomValidity('')" 
                                                                                                         name="ponPetakOd"   value="<?php if(isset($resetujSveS)||!empty($errorsSalon['ponPetakOd'])) echo ""; else echo set_value('ponPetakOd') ?>">
                                         &nbsp;&nbsp; Do  <input class="inpt2 "
                                                                 required 
                                          oninvalid="this.setCustomValidity('Morate uneti vreme!')" oninput="setCustomValidity('')" 
                                                                 
                                                                 type="time" value="<?php if(isset($resetujSveS)||!empty($errorsSalon['ponPetakOd'])) echo ""; else echo set_value('ponPetakDo') ?>" id="do"  placeholder="DO" name="ponPetakDo"></td>
                                    </tr>
                                            ...
                                            top: -25px; left:10px" id="red0">
                                                ...
                                                <td id="ubaciDrugo0">
                                                    <input type="number" 
                                                           ...
                                                           class="inpt4" id="cena0_0" name="cena0_0" placeholder="RSD" min="0" >
                                                 </td>
                                                <td id="ubaciTrece0"> <input class="inpt4" 
                                                                     
                                                                             
                                                                             id="cena0_1" type="number" name="cena0_1" placeholder="RSD" min="0" ></td>
                                                 <td id="ubaciCetvrto0" class="menjajTabela">
                                                     <input type="number"  
                                                       
                                                            class="inpt4" id="cena0_2" name="cena0_2" placeholder="RSD" min="0" >
                                                 </td>
                                            </tr>
