...
CREATE TABLE IF NOT EXISTS `psi_konacno`.`Registrovanikorisnik` (
  ...
  UNIQUE INDEX `IdRK_UNIQUE` (`IdRK` ASC) VISIBLE)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `psi_konacno`.`CenaUsluge` (
  ...
  PRIMARY KEY (`IdSalon`, `IdUsluga`),
  INDEX `IdUsluga_CenaUsluge_idx` (`IdUsluga` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `psi_konacno`.`Ocenio` (
  ...
  `IdSalon` INT NOT NULL,
  `Ocena` INT NOT NULL,
  PRIMARY KEY (`IdKorisnik`, `IdSalon`),
  INDEX `IdSalon_Ocenio_idx` (`IdSalon` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `psi_konacno`.`OstavioRecenziju` (
  ...
  INDEX `IdRK_OstavioRecenziju_idx` (`IdKorisnik` ASC) VISIBLE,
  INDEX `IdSalon_OstavioRecenziju_idx` (`IdSalon` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `psi_konacno`.`Tretman` (
  ...
  UNIQUE INDEX `brojTelefona_UNIQUE` (`brojTelefona` ASC) VISIBLE,
  INDEX `IdRK_Tretman_idx` (`idKorisnik` ASC) VISIBLE,
  INDEX `IdSalon_Tretman_idx` (`IdSalon` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `psi_konacno`.`Sadrzi` (
  ...
  PRIMARY KEY (`IdUsluga`, `IdTretman`),
  INDEX `IdTretman_Izabrao_idx` (`IdTretman` ASC) VISIBLE,
